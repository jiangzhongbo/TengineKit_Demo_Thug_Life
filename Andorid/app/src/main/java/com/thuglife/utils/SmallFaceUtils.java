...
public class SmallFaceUtils {
    ...
    public static Bitmap smallFaceMesh(Bitmap bitmap, List<Point> leftFacePoint,List<Point> rightFacePoint,Point centerPoint, int level) {
        ...
        int r = 180 + 15 * level;
//        warp(COUNT,verts,leftFacePoint.get(4).x,leftFacePoint.get(4).y,centerPoint.x,centerPoint.y,r);
        warp(COUNT,verts,leftFacePoint.get(15).x,leftFacePoint.get(15).y,centerPoint.x,centerPoint.y,r);

//        warp(COUNT,verts,rightFacePoint.get(4).x,rightFacePoint.get(4).y,centerPoint.x,centerPoint.y,r);
        warp(COUNT,verts,rightFacePoint.get(15).x,rightFacePoint.get(15).y,centerPoint.x,centerPoint.y,r);
